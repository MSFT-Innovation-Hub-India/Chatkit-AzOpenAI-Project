...
CONTAINERS = {
    ...
    "return_reasons": "Retail_ReturnReasons",
    "resolution_options": "Retail_ResolutionOptions",
    "shipping_options": "Retail_ShippingOptions",
    "discount_offers": "Retail_DiscountOffers",
    "returns": "Retail_Returns",
    "customer_notes": "Retail_CustomerNotes",
    "demo_scenarios": "Retail_DemoScenarios",
}
...
class RetailCosmosClient:
    ...
    def _get_container(self, name: str):
        ...
        if name not in self._containers:
            container_name = CONTAINERS.get(name, name)
