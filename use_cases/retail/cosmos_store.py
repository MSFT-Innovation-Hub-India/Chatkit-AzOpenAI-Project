...
class CosmosDBStore(Store):
    ...
    def __init__(
        self,
        endpoint: str = "https://common-nosql-db.documents.azure.com:443/",
        database_name: str = "db001",
        threads_container: str = "ChatKit_Threads",
        items_container: str = "ChatKit_Items",
    ):
        """
